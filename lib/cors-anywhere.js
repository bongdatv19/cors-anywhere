...
function getHandler(options, proxy) {
  console.log('LOGG - getHandler - options: ' + options + 'proxy: ' + proxy);
  var corsAnywhere = {
  ...
  if (corsAnywhere.requireHeader) {
    console.log('LOGG - corsAnywhere.requireHeader' + corsAnywhere.requireHeader);
    if (typeof corsAnywhere.requireHeader === 'string') {
      ...
      corsAnywhere.requireHeader = corsAnywhere.requireHeader.map(function(headerName) {
        console.log('LOGG - 3' + headerName);
        return headerName.toLowerCase();
      });
    }
  }
  var hasRequiredHeaders = function(headers) {
    console.log('LOGG - hasRequiredHeaders ' + JSON.stringify(headers, null, 4));
    return !corsAnywhere.requireHeader || corsAnywhere.requireHeader.some(function(headerName) {
      console.log('LOGG - headers ' + JSON.stringify(headers, null, 4) );
      console.log('LOGG - headerName ' + headerName );
